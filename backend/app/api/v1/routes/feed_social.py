"""Personal activity feed, plus a compatibility boundary for the retired
standalone friends feed."""
...
from app.services.social.activity_service import list_user_activity

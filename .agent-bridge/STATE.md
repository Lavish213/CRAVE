...
Next action: review the PR, run it on device/simulator, then open a separate
follow-up for full Search/Map 16-state resilience/accessibility proof if this
slice is accepted.
